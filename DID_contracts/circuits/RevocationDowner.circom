...
template revocationDowner(DID_level,ID_level){
    //public signal
    signal input DIDRoot;
    signal input HashedIDRoot;
    signal input revocation_Hash;//要删的DID树叶子节点hash
    ...
    revocation_Hash === DID_leaf_hash.out;
    ...
    SIG_Verifier[1].M <== hashSalt.out;

}

component main{public [ DIDRoot,HashedIDRoot,revocation_Hash,DID_Key] } = revocationDowner(3,3);
